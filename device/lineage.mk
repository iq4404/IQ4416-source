# Release name
PRODUCT_RELEASE_NAME := IQ4416

# Inherit some common CM stuff.
$(call inherit-product, vendor/cm/config/common_full_phone.mk)

# Inherit device configuration
$(call inherit-product, device/Fly/IQ4416/device_IQ4416.mk)
...
PRODUCT_DEVICE := IQ4416
PRODUCT_NAME := lineage_IQ4416
PRODUCT_BRAND := Fly
PRODUCT_MODEL := Fly IQ4416
